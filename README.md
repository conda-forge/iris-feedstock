...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/iris-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/iris-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add iris scitools-iris
# for installing globally
pixi global install iris scitools-iris
```
...
It is possible to list all of the versions of `iris` available on your platform:
...
```
pixi search iris --channel conda-forge
```
